...
public class OrderManager {
    ...
    public OrderManager(InetSocketAddress[] orderRouters, InetSocketAddress[] clients, InetSocketAddress trader, LiveMarketData liveMarketData) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        /**Ali - Can be converted to for loop instead of for each to get rid of the counter*/
            ...
            if (0 < this.trader.getInputStream().available()) {
                ...
                switch (method) {
                    ...
                    case "sliceOrder":
                        ...
                        break;
                    case "deleteOrder":
                        deleteOrder(is.readInt(), (Order)is.readObject());
                }
            }
        }
    }
    ...
    private void deleteClientOrder(int id, Order o) throws IOException {
        ObjectOutputStream os = new ObjectOutputStream(clients[o.clientOrderID].getOutputStream());
