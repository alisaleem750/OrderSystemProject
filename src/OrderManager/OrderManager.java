...
//			deleteOrder(id);
	...
	private synchronized void newOrder(int clientId, int clientOrderId, NewOrderSingle nos) throws IOException{
...
//			Database.write(o);
	...
	private synchronized void price(int id,Order o) throws IOException{
